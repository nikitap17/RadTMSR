...
nounbydoc <- read_csv("../RTMR_Output/nounbydoc_study2.csv")
#View(nounbydoc)
...
write.csv(word_freq, "../RTMR_Output/Keywords_freq_study2.csv", row.names = FALSE)
...
ggsave("../RTMR_Output/Keywords_entropies_study2_study2.png", p, device = "png", dpi = 600)
...
ggsave("../RTMR_Output/Keywords_ll_study2.png", p, device = "png", dpi = 600)
...
ggsave("../RTMR_Output/Keywords_BIC_study2.png", p, device = "png", dpi = 600)
...
df_plot <- df_plot[!duplicated(df_plot$id), ]
df_plot_incl_radicalism <- df_plot
write.csv(df_plot_incl_radicalism, "../RTMR_Output/Keywords_cooc_inclrad_study2.csv", row.names = FALSE)
...
df_plot$id <- apply(df_plot[, c("term1", "term2")], 1, function(x)paste0(sort(x), collapse = ""))
df_plot <- df_plot[!duplicated(df_plot$id), ]
write.csv(df_plot, "../RTMR_Output/Keywords_cooc_worad_study2.csv", row.names = FALSE)
...
df_plot$id <- apply(df_plot[, c("term1", "term2")], 1, function(x)paste0(sort(x), collapse = ""))
df_plot <- df_plot[!duplicated(df_plot$id), ]
write.csv(df_plot, "../RTMR_Output/Keywords_cooc_adolescence_study2.csv", row.names = FALSE)
...
df_plot$id <- apply(df_plot[, c("term1", "term2")], 1, function(x)paste0(sort(x), collapse = ""))
df_plot <- df_plot[!duplicated(df_plot$id), ]
write.csv(df_plot, "../RTMR_Output/Keywords_cooc_islamist_study2.csv", row.names = FALSE)
...
df_plot$id <- apply(df_plot[, c("term1", "term2")], 1, function(x)paste0(sort(x), collapse = ""))
df_plot <- df_plot[!duplicated(df_plot$id), ]
write.csv(df_plot, "../RTMR_Output/Keywords_cooc_far-right_study2.csv", row.names = FALSE)
...
set.seed(52)
cooc <- select_cooc(create_cooc(dtm_top), q = .95)
#write.csv(as.matrix(cooc), "s1_cooc.csv")
df_plot <- as_cooccurrence(cooc)
df_plot <- df_plot[!df_plot$term1 == df_plot$term2, ]
df_plot <- df_plot[order(df_plot$cooc, decreasing = TRUE), ]
...
df_plot$id <- apply(df_plot[, c("term1", "term2")], 1, function(x)paste0(sort(x), collapse = ""))
df_plot <- df_plot[!duplicated(df_plot$id), ]
write.csv(df_plot, "../RTMR_Output/Keywords_cooc_far-left_study2.csv", row.names = FALSE)
...
df_plot$id <- apply(df_plot[, c("term1", "term2")], 1, function(x)paste0(sort(x), collapse = ""))
df_plot <- df_plot[!duplicated(df_plot$id), ]
write.csv(df_plot, "../RTMR_Output/Keywords_cooc_lone-actor_study2.csv", row.names = FALSE)
